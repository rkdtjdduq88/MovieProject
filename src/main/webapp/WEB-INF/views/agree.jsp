...
<ul class="terms_list">
	<li class="terms_item">
		<div class="terms_box" tabindex="" id="agree">
			<h2>(목적)</h2>
	...
	<li class="terms_item">
		...
		<div class="check_terms">
			<div class="check_wrap">
				<input type="checkbox" id="termSelect" class="blind" />
